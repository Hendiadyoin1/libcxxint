 ...
 */
static void CINTgout1e_int1e_r2_origi(double *gout, double *g, int *idx, CINTEnvVars *envs, int empty) {
        int nf = envs->nf;
        int ix, iy, iz, n;
        double *g0 = g;
...
int int1e_r2_origi_spinor(std::complex<double> *out, int *dims, int *shls,
                int *atm, int natm, int *bas, int nbas, double *env, CINTOpt *opt) {
        int ng[] = {2, 0, 0, 0, 2, 1, 1, 1};
        CINTEnvVars envs;
        CINTinit_int1e_EnvVars(&envs, ng, shls, atm, natm, bas, nbas, env);
 ...
 */
static void CINTgout1e_int1e_r4_origi(double *gout, double *g, int *idx, CINTEnvVars *envs, int empty) {
        int nf = envs->nf;
        int ix, iy, iz, n;
        double *g0 = g;
        double *g1 = g0  + envs->g_size * 3;
...
int int1e_r4_origi_spinor(std::complex<double> *out, int *dims, int *shls,
                int *atm, int natm, int *bas, int nbas, double *env, CINTOpt *opt) {
        int ng[] = {4, 0, 0, 0, 4, 1, 1, 1};
        CINTEnvVars envs;
        CINTinit_int1e_EnvVars(&envs, ng, shls, atm, natm, bas, nbas, env);
