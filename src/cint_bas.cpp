...
static int tot_cgto_accum(int (*f)(const int bas_id, const int *bas), const int *bas, const int nbas)
{
        int i;
        int s = 0;
...
static void shells_cgto_offset(int (*f)(const int bas_id, const int *bas), int ao_loc[],
