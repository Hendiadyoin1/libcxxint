...
int *atm, int natm, int *bas, int nbas, double *env, CINTOpt *opt) {~%" intname)
...
return 0; }~%")))
      (format fout "return CINT1e_drv(out, dims, &envs, &c2s_cart_1e, ~d);
...
c2s_dset0(out+nout*i, dims, counts); }
return 0; }~%")))
      (format fout "return CINT1e_drv(out, dims, &envs, &c2s_sph_1e, ~d);
} // ~a_sph~%" int1e-type intname)
;;; _spinor
      (format fout "int ~a_spinor(std::comlpex<double> *out, int *dims, int *shls,
int *atm, int natm, int *bas, int nbas, double *env, CINTOpt *opt) {~%" intname)
      (format fout envs-common)
      (when (member 'g raw-infix)
        (when (or (member 'g bra-i) (member 'g ket-j))
...
return 0; }~%")))
      (format fout "return CINT1e_spinor_drv(out, dims, &envs, ~a, ~d);
...
c2s_dset0(out+nout*i, dims, counts); }
return 0; }~%")))
      (format fout "return CINT2e_cart_drv(out, dims, &envs, opt);~%} // ~a_cart~%" intname)
;;; _sph
      (format fout "int ~a_sph(double *out, int *dims, int *shls,
int *atm, int natm, int *bas, int nbas, double *env, CINTOpt *opt) {~%" intname)
      (format fout envs-common)
...
c2s_dset0(out+nout*i, dims, counts); }
return 0; }~%")))
      (format fout "return CINT2e_spheric_drv(out, dims, &envs, opt);~%} // ~a_sph~%" intname)
;;; _spinor
      (format fout "int ~a_spinor(std::comlpex<double> *out, int *dims, int *shls,
int *atm, int natm, int *bas, int nbas, double *env, CINTOpt *opt) {~%" intname)
      (format fout envs-common)
...
c2s_zset0(out+nout*i, dims, counts); }
return 0; }~%")))
      (format fout "return CINT2e_spinor_drv(out, dims, &envs, opt, ~a, ~a);
...
c2s_dset0(out+nout*i, dims, counts); }
return 0; }~%")))
      (format fout "return CINT3c2e_cart_drv(out, dims, &envs, opt);~%} // ~a_cart~%" intname)
;;; _sph
      (format fout "int ~a_sph(double *out, int *dims, int *shls,
int *atm, int natm, int *bas, int nbas, double *env, CINTOpt *opt) {~%" intname)
      (format fout envs-common)
...
c2s_dset0(out+nout*i, dims, counts); }
return 0; }~%")))
      (format fout "return CINT3c2e_spheric_drv(out, dims, &envs, opt, &c2s_sph_3c2e1, 0);
} // ~a_sph~%" intname)
;;; _spinor
      (format fout "int ~a_spinor(std::comlpex<double> *out, int *dims, int *shls,
int *atm, int natm, int *bas, int nbas, double *env, CINTOpt *opt) {~%" intname)
...
c2s_zset0(out+nout*i, dims, counts); }
return 0; }~%")))
      (format fout "return CINT3c2e_spinor_drv(out, dims, &envs, opt, ~a, 0);
...
FINT *atm, FINT natm, FINT *bas, FINT nbas, double *env, CINTOpt *opt) {~%" intname)
      (format fout envs-common)
      (format fout "return CINT2c2e_cart_drv(out, dims, &envs, opt);~%} // ~a_cart~%" intname)
;;; _sph
      (format fout "FINT ~a_sph(double *out, FINT *dims, FINT *shls,
FINT *atm, FINT natm, FINT *bas, FINT nbas, double *env, CINTOpt *opt) {~%" intname)
      (format fout envs-common)
      (format fout "return CINT2c2e_spheric_drv(out, dims, &envs, opt);~%} // ~a_sph~%" intname)
;;; _spinor
      (format fout "FINT ~a_spinor(std::comlpex<double> *out, FINT *dims, FINT *shls,
FINT *atm, FINT natm, FINT *bas, FINT nbas, double *env, CINTOpt *opt) {~%" intname)
      (format fout envs-common)
      ; c2s_ function is incorrect if e1/e2 are spin-included operators
      (format fout "return CINT2c2e_spinor_drv(out, dims, &envs, opt, ~a);
...
c2s_dset0(out+nout*i, dims, counts); }
return 0; }~%")))
      (format fout "return CINT3c1e_cart_drv(out, dims, &envs, opt, ~d);~%}
// ~a_cart~%" int1e-type intname)
;;; _sph
      (format fout "FINT ~a_sph(double *out, FINT *dims, FINT *shls,
FINT *atm, FINT natm, FINT *bas, FINT nbas, double *env, CINTOpt *opt) {~%" intname)
...
c2s_dset0(out+nout*i, dims, counts); }
return 0; }~%")))
      (format fout "return CINT3c1e_spheric_drv(out, dims, &envs, opt, &c2s_sph_3c1e, ~d, 0);
} // ~a_sph~%" int1e-type intname)
;;; _spinor
      (format fout "FINT ~a_spinor(std::comlpex<double> *out, FINT *dims, FINT *shls,
FINT *atm, FINT natm, FINT *bas, FINT nbas, double *env, CINTOpt *opt) {~%" intname)
...
c2s_zset0(out+nout*i, dims, counts); }
return 0; }~%")))
      (format fout "return CINT3c1e_spinor_drv(out, dims, &envs, opt, ~a, ~d, 0);
